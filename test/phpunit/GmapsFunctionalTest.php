...
/**
 * \file    test/phpunit/GmapsFunctionalTest.php
 * \ingroup gmaps
 ...
 * @package Testgmaps
 */
class GmapsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/gmaps/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('gmaps/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/gmaps/admin/about.php');
		$this->authenticate();
		return $this->assertContains('gmaps/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('gmapswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGmaps_GmapsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGmaps_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
