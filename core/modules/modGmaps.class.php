 ...
 * Copyright (C) 2020 SuperAdmin <admin@test.com>
 *
...
/**
 * 	\defgroup   gmaps     Module Gmaps
 *  \brief      Gmaps module descriptor.
 *
 *  \file       htdocs/gmaps/core/modules/modGmaps.class.php
 *  \ingroup    gmaps
 *  \brief      Description and activation file for module Gmaps
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module Gmaps
 */
class modGmaps extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		// Module label (no space allowed), used if translation string 'ModuleGmapsName' not found (Gmaps is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));
		// Module description, used if translation string 'ModuleGmapsDesc' not found (Gmaps is name of module).
		...
		// Key used in llx_const table to save module status enabled/disabled (where GMAPS is value of property name of module in uppercase)
		...
		$this->module_parts = array(
			...
			'css' => array(
				//    '/gmaps/css/gmaps.css.php',
			),
			// Set this to relative path of js file if module must load a js on all pages
			'js' => array(
				//   '/gmaps/js/gmaps.js.php',
			),
		...
		// Example: this->dirs = array("/gmaps/temp","/gmaps/subdir");
		$this->dirs = array("/gmaps/temp");
		// Config pages. Put here list of php page, stored into gmaps/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@gmaps");
		// Dependencies
		...
		$this->langfiles = array("gmaps@gmaps");
		$this->phpmin = array(5, 5); // Minimum version of PHP required by module
		$this->need_dolibarr_version = array(11, -3); // Minimum version of Dolibarr required by module
		$this->warnings_activation = array(); // Warning to show when we activate module. array('always'='text') or array('FR'='textfr','ES'='textes'...)
		$this->warnings_activation_ext = array(); // Warning to show when we activate an external module. array('always'='text') or array('FR'='textfr','ES'='textes'...)
		//$this->automatic_activation = array('FR'=>'GmapsWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('GMAPS_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		...
		if (!isset($conf->gmaps) || !isset($conf->gmaps->enabled)) {
			$conf->gmaps = new stdClass();
			$conf->gmaps->enabled = 0;
		}

		// Array to add new pages in new tabs
		$this->tabs = array();
		// Example:
		// $this->tabs[] = array('data'=>'objecttype:+tabname1:Title1:mylangfile@gmaps:$user->rights->gmaps->read:/gmaps/mynewtab1.php?id=__ID__');  					// To add a new tab identified by code tabname1
		// $this->tabs[] = array('data'=>'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@gmaps:$user->rights->othermodule->read:/gmaps/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		...
		$this->dictionaries=array(
			...
			'tabcond'=>array($conf->gmaps->enabled, $conf->gmaps->enabled, $conf->gmaps->enabled)
		);
		*/

		// Boxes/Widgets
		// Add here list of php file(s) stored in gmaps/core/boxes that contains a class to show a widget.
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'gmapswidget1.php@gmaps',
			//      'note' => 'Widget provided by Gmaps',
		...
		$this->cronjobs = array(
			...
			//      'unitfrequency' => 3600,
			//      'status' => 0,
			//      'test' => '$conf->gmaps->enabled',
			//      'priority' => 50,
			//  ),
		);
		// Example: $this->cronjobs=array(
		//    0=>array('label'=>'My label', 'jobtype'=>'method', 'class'=>'/dir/class/file.class.php', 'objectname'=>'MyClass', 'method'=>'myMethod', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>'$conf->gmaps->enabled', 'priority'=>50),
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'$conf->gmaps->enabled', 'priority'=>50)
		// );
		...
		*/
		...
		$this->menu[$r++]=array(
			...
			// This is a Left menu entry
			'type'=>'left',
			'titre'=>'GmapsAreaTemps',
			'mainmenu'=>'gmaps',
			'leftmenu'=>'gmaps_gmaps_time',
			'url'=>'/gmaps/gmaps_analyses_time.php',
			// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'langs'=>'gmaps@gmaps',
			'position'=>1101+$r,
			// Define condition to show or hide menu entry. Use '$conf->gmaps->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
	...
	public function init($options = '')
	{
		...
		$result = $this->_load_tables('/gmaps/sql/');
		...
		//$result5=$extrafields->addExtraField('gmaps_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'gmaps@gmaps', '$conf->gmaps->enabled');
