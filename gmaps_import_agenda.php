...
/**
 *  \file       gmaps_import_agenda.php
 *  \ingroup    gmaps
 *  \brief      Tab of events on Gmaps_import
 */
...
if ($object->id > 0)
{
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Gmaps_import"), -1, 'object_'.$object->picto);
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read)))
	{
		...
		//print load_fiche_titre($langs->trans("ActionsOnGmaps_import"), '', '');
