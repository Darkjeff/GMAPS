...
/**
 *   	\file       gmaps_activity_list.php
 *		\ingroup    gmaps
 *		\brief      List page for gmaps_activity
 */
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'gmaps_activitylist'; // To manage different context of search
...
$hookmanager->initHooks(array('gmaps_activitylist')); // Note that conf->hooks_modules contains array
...
$permissiontoadd = $user->rights->gmaps->gmaps_activity->write;
$permissiontodelete = $user->rights->gmaps->gmaps_activity->delete;
...
//$help_url="EN:Module_Gmaps_activity|FR:Module_Gmaps_activity_FR|ES:Módulo_Gmaps_activity";
$help_url = '';
$title = $langs->trans('ListOf', $langs->transnoentitiesnoconv("Gmaps_activitys"));
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page)
{
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/gmaps/gmaps_activity_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/gmaps/gmaps_activity_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendGmaps_activityRef";
$modelmail = "gmaps_activity";
$objecttmp = new Gmaps_activity($db);
