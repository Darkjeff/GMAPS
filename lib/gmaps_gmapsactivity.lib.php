...
function gmapsActivityPrepareHead($object)
{
	...
	$head[$h][0] = dol_buildpath("/gmaps/gmaps_activity_card.php", 1).'?id='.$object->id;
	...
	if (isset($object->fields['note_public']) || isset($object->fields['note_private']))
	{
		...
		$head[$h][0] = dol_buildpath('/gmaps/gmaps_activity_note.php', 1).'?id='.$object->id;
	...
	$head[$h][0] = dol_buildpath("/gmaps/gmaps_activity_agenda.php", 1).'?id='.$object->id;
